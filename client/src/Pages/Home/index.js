...
import Offer from "../../components/home/SpecialOffers/SpecialOffers"
...
{/* <Offer/> */}
      {/* Product List */}
       <div className="bg-red-500 w-full pb-20 mt-3 text-slate-800">
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 bg-yellow-300">
          <h2 className="text-6xl font-bold ">
            Products
          </h2>

          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8 bg-sky-500">
            {productlist.map((product) => (
              <div class="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-red-500 bg-white shadow-md"> {/*border-gray-100 */}
                <Link
